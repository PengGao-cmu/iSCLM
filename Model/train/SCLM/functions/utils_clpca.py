...
def generate_dataset(pca_feature_dimension, feature_path, feature_name_path, slide_patch_adj_path, use_knn_graph,
    ...
    # with open('./weight_adj.json') as f:
    #     dic_slide_adj = json.load(f)
    ...
    return dic_name_data, data_name, slide_name_order, dic_slide_patch  # pos_name_data, neg_name_data, data_pos_name, data_neg_name
