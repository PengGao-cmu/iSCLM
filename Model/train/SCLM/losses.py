...
class SupConLoss(nn.Module):
    ...
    def __init__(self, temperature=0.1, contrast_mode='all',
        ...
        print('loss param',temperature, base_temperature)
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        for i in range(batch_size):
            moremask.append([0] * batch_size + [1] * batch_size)#a
            #moremask.append([1] * batch_size + [1] * batch_size)#b
        for i in range(batch_size):
            moremask.append([1] * batch_size + [0] * batch_size)#c
            # moremask.append([1] * batch_size + [1] * batch_size)#d    #SCLM-d:b and d; SCLM-e: a and c; SCLM-f: b and c
...
if __name__ == '__main__':
    ...
    pahtology = torch.tensor([[24,9,10,14,16,2],[24,19,10,14,16,2],[24,5,3,2,5,4],[21,2,2,2,3,4]])
    # print(img.shape)
    # print(bl.shape)
    labels = torch.tensor([1,1,0,0])
    features = torch.stack([img,pahtology], dim=1)
