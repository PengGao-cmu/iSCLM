...
dic_name_data, _, slide_name_order, dic_slide_patch = generate_dataset(8, feature_path5, feature_name_path5, adj_path5,
...
if __name__ == '__main__':
    ...
    for a, b in fold.split(X=Xx, y=Yy):
        ...
        img_optimizer1 = torch.optim.AdamW(image_encoder.parameters(), lr=0.0001) # 没加wd
