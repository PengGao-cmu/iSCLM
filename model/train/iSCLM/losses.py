...
class SupConLoss(nn.Module):
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        for i in range(batch_size):
            #moremask.append([0] * batch_size + [1] * batch_size) # only bl_yx
            moremask.append([1] * batch_size + [1] * batch_size) # 影像的类内信息
        for i in range(batch_size):
            #moremask.append([1] * batch_size + [0] * batch_size) # only bl_yx
            moremask.append([1] * batch_size + [1] * batch_size) # 病理的类内信息也算进来
